# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Scraper de películas para PalcoTV
...
def getposter(title):
    plugintools.log('[%s %s] Scraper de películas %s' % (addonName, addonVersion, title))
...
def save_url(url, filename):
    plugintools.log('[%s %s] Salvando URL... %s' % (addonName, addonVersion, url))   
...
def themoviedb(title, datamovie):
    plugintools.log('[%s %s] Scraper themoviedb para... %s' % (addonName, addonVersion, title))       
